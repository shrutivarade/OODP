...
class DirectoryTest {
    ...
    public void verifyEqualityForDirectoryRoot(){
        String[] expected = new String[]{"false","root", "0",null,String.valueOf(ldt),"5","5"};
    ...
    public void verifyEqualityForDirectoryApps (){
        String[] expected = new String[]{"false","Apps", "0","root",String.valueOf(ldt),"1","1"};
    ...
    public void verifyEqualityForDirectoryBin (){
        String[] expected = new String[]{"false","bin", "0","root",String.valueOf(ldt),"1","1"};
    ...
    public void verifyEqualityForDirectoryHome () {
        String[] expected = new String[]{"false","home", "0","root",String.valueOf(ldt),"2","3"};
